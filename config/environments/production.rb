...
Rails.application.configure do
  ...
  config.public_file_server.enabled = ENV['RAILS_SERVE_STATIC_FILES'].present? || ENV['RENDER'].present? # for deploy to Render
  ...
  # config.active_job.queue_name_prefix = "mmw_production"
